...
public class Main {
    ...
    public  static void main(String[] args) throws IOException {
        ...
        MultiWindowTextGUI gui = new MultiWindowTextGUI(new SeparateTextGUIThread.Factory(), screen, new DefaultWindowManager(), new WindowShadowRenderer(), new EmptySpace(TextColor.ANSI.CYAN));
